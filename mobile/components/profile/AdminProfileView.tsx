  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.muted}>- Permissions / access level</Text>
        <Text style={styles.muted}>- Activity log</Text>
        <Text style={styles.muted}>- Change password</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  avatar: { alignSelf: 'center', width: 90, height: 90, borderRadius: 45, backgroundColor: '#1d4ed8', alignItems: 'center', justifyContent: 'center', marginBottom: 6 },
  avatarText: { color: '#fff', fontWeight: '900', fontSize: 28 },
  kicker: { color: '#1d4ed8', fontWeight: '800', letterSpacing: 1, textTransform: 'uppercase', fontSize: 12, textAlign: 'center' },
